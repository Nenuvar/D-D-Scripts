...
# AI generated environment description is commented out of the code, but you can uncomment it if you want to use it.
import os
import random
...
def save_encounter_to_md(encounter, folder_path=""): #Add ", environment_description" right after "folder_path" if you want to use the AI-generated environment description
    """
    ...
    encounter_title = generate_encounter_title(
     ...
     # Generate the battlemap prompt first
    battlemap_prompt = generate_battlemap_prompt(environment)

    # Now generate the environment description based on the battlemap prompt
    # environment_description = generate_environment_description({
    #     "name": environment,
    #     "main_monster": main_monster_name,
    #     "battlemap_prompt": battlemap_prompt
    # })
...
def main():
    ...
    encounter = generate_encounter(filtered_monsters, max_xp, config_file)#Add ", environment_description" right after "encounter" if you want to use the AI-generated environment description
    ...
    save_encounter_to_md(encounter, folder_path) #Add ", environment_description" right after "folder_path" if you want to use the AI-generated environment description
