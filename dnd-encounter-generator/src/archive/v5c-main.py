...
# This only works with the v2c_ai_client.py file in /archive/ai_client/
#This version includes the AI battlemap prompt, but not the Bing Image Creator
import os
import random
...
import sys
import re
from ai_client import generate_environment_description, generate_battlemap_prompt
...
def save_encounter_to_md(encounter, folder_path, environment_description="", battlemap_prompt=""):
    """
...
def main():
    ...
    save_encounter_to_md(encounter, folder_path, environment_description, battlemap_prompt)
